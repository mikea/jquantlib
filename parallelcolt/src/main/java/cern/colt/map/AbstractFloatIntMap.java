...
import cern.colt.function.FloatIntProcedure;
 ...
 * <tt>(float-->int)</tt>. First see the <a
 ...
 */
public abstract class AbstractFloatIntMap extends AbstractFloatMap {
	 ...
	 * by method {@link #forEachKey(FloatProcedure)}.
	 * 
	 * @param procedure
	 *            the procedure to be applied. Stops iteration if the procedure
	 *            returns <tt>false</tt>, otherwise continues.
	 ...
	 *         returns <tt>Float.NaN</tt> if no such key exists.
	 */
	 ...
	 */
	public void pairsMatching(final FloatIntProcedure condition, final FloatArrayList keyList, final IntArrayList valueList) {
		keyList.clear();
		valueList.clear();
