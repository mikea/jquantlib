 ...
 */
public abstract class AbstractFloatMap extends cern.colt.PersistentObject {
	 ...
	 */
	protected int chooseHighWaterMark(int capacity, float maxLoad) {
	 ...
	 * @return int the new threshold.
	 */
	protected int chooseLowWaterMark(int capacity, float minLoad) {
