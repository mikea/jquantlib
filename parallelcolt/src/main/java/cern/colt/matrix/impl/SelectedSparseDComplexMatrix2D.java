...
class SelectedSparseDComplexMatrix2D extends DComplexMatrix2D {
	 ...
	 * @param offset
	 */
	protected SelectedSparseDComplexMatrix2D(int rows, int columns, ConcurrentHashMap<Integer, double[]> elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
	 ...
	 * @param offset
	 */
	protected SelectedSparseDComplexMatrix2D(ConcurrentHashMap<Integer, double[]> elements, int[] rowOffsets, int[] columnOffsets, int offset) {
