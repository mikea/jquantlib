...
class SelectedDenseFloatMatrix1D extends FloatMatrix1D {
	...
	public float[] getElements() {
		throw new IllegalAccessError("getElements() is not supported for SelectedDenseFloatMatrix1D.");
	}
	...
	public FloatMatrix2D reshape(int rows, int cols) {
		throw new IllegalAccessError("reshape is not supported for SelectedDenseFloatMatrix1D.");
	}
