...
public class Partitioning extends Object {
	 ...
	 * </table>
	 */
	private static void xPartitionOld(FloatMatrix2D matrix, FloatMatrix1D column, int from, int to, float[] splitters, int splitFrom, int splitTo, int[] splitIndexes) {
		/*
		 * float splitter; // int, float --> template type dependent
		 * 
	 ...
	 * Note that arguments are not checked for validity.
	 */
	private static int xPartitionOld(FloatMatrix2D matrix, FloatMatrix1D column, int from, int to, float splitter) {
		/*
		 * float element; // int, float --> template type dependent for (int
