...
import cern.colt.matrix.FloatMatrix3DProcedure;
...
public class Stencil extends Object {
	 ...
	 */
	public static int stencil27(FloatMatrix3D A, cern.colt.function.Float27Function function, int maxIterations, FloatMatrix3DProcedure hasConverged, int convergenceIterations) {
	 ...
	 * @return the number of iterations actually executed.
	 */
	public static int stencil9(FloatMatrix2D A, cern.colt.function.Float9Function function, int maxIterations, FloatMatrix2DProcedure hasConverged, int convergenceIterations) {
