 ...
 * is passed as format string, {@link java.lang.Float#toString(float)} is used
...
public class Formatter extends AbstractFormatter {
	...
	public static void demo1() {
		...
		FloatMatrix2D matrix = cern.colt.matrix.FloatFactory2D.dense.make(values);
	...
	public static void demo3(int size, float value) {
		...
		String s;
		StringBuffer buf;
		FloatMatrix2D matrix = cern.colt.matrix.FloatFactory2D.dense.make(size, size, value);
	...
	public static void demo5() {
		...
		System.out.println(new Formatter("%G").toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
	}
	...
	public static void demo6() {
		...
		System.out.println(new Formatter().toString(cern.colt.matrix.FloatFactory2D.dense.make(values)));
		System.out.println(new Formatter().toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
	}
	...
	public static void demo7() {
		...
		hep.aida.bin.FloatBinFunctions1D F = hep.aida.bin.FloatBinFunctions1D.functions;
		hep.aida.bin.FloatBinFunction1D[] aggr = { F.mean, F.rms, F.quantile(0.25f), F.median, F.quantile(0.75f), F.stdDev, F.min, F.max };
		String format = "%1.2G";
		...
		System.out.println(new Formatter(format).toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, rowAxisName, columnAxisName, title, aggr));
	 ...
	 */
	public String toTitleString(FloatMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title, hep.aida.bin.FloatBinFunction1D[] aggr) {
		if (matrix.size() == 0)
			return "Empty matrix";
		...
		cern.colt.matrix.floatalgo.Statistic.aggregate(matrix, aggr, colStats); // aggregate
		// an
		// entire
		// column
		// at a
		// time
		cern.colt.matrix.floatalgo.Statistic.aggregate(matrix.viewDice(), aggr, rowStats.viewDice()); // aggregate
		// an
		// entire
		// row
		// at a
	 ...
	 * @see hep.aida.bin.FloatBinFunctions1D
	 */
	public String toTitleString(FloatMatrix3D matrix, String[] sliceNames, String[] rowNames, String[] columnNames, String sliceAxisName, String rowAxisName, String columnAxisName, String title, hep.aida.bin.FloatBinFunction1D[] aggr) {
		if (matrix.size() == 0)
			return "Empty matrix";
		StringBuffer buf = new StringBuffer();
