 ...
 * dense matrices, <tt>DoubleFactory2D.sparse.make(4,4)</tt> to construct
 * sparse matrices.</td>
 * </tr>
 * <tr align="left" valign="top">
 ...
 * <td>Use methods
 * {@link #appendColumns(DoubleMatrix2D,DoubleMatrix2D) appendColumns},
 ...
 * #diagonal(DoubleMatrix2D) diagonal(matrix)} and
...
public class DoubleFactory2D extends cern.colt.PersistentObject {
	...
	public DoubleMatrix2D random(int rows, int columns) {
		return make(rows, columns).assign(cern.jet.math.DoubleFunctions.random());
	}
