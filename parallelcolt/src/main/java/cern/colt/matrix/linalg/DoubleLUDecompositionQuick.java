...
/**
 * A low level version of {@link DoubleLUDecomposition}, avoiding unnecessary
 ...
 * <p>
 */
public class DoubleLUDecompositionQuick implements java.io.Serializable {
	...
	protected DoubleAlgebra algebra;
	...
	public DoubleLUDecompositionQuick(double tolerance) {
		this.algebra = new DoubleAlgebra(tolerance);
	}
	...
	public void decompose(DoubleMatrix2D A) {
		...
		cern.jet.math.DoubleMult multFunction = cern.jet.math.DoubleMult.mult(0);
	 ...
	 * to {@link #decompose(DoubleMatrix2D)}.
	 * 
	 * @param semiBandwidth ==
	...
	public void solve(DoubleMatrix2D B) {
		...
		// transformations
		cern.jet.math.DoubleMult div = cern.jet.math.DoubleMult.div(0);
		cern.jet.math.DoublePlusMult minusMult = cern.jet.math.DoublePlusMult.minusMult(0);

		cern.colt.list.IntArrayList nonZeroIndexes = new cern.colt.list.IntArrayList(); // sparsity
		DoubleMatrix1D Browk = cern.colt.matrix.DoubleFactory1D.dense.make(nx); // blocked
		// row
		// k
