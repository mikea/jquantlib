 ...
 * {@link #setTolerance(double)}. Note that the public static final Property
...
public class DoubleProperty extends cern.colt.PersistentObject {
	...
	public void generateNonSingular(DoubleMatrix2D A) {
		checkSquare(A);
		cern.jet.math.DoubleFunctions F = cern.jet.math.DoubleFunctions.functions;
	...
	public boolean isSingular(DoubleMatrix2D A) {
		return !(Math.abs(DoubleAlgebra.DEFAULT.det(A)) >= tolerance());
	}
