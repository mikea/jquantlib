...
public class SmpFloatBlas implements FloatBlas {
	...
	public void assign(FloatMatrix2D A, final cern.colt.function.FloatFunction function) {
		A.assign(function);
	}

	public void assign(FloatMatrix2D A, FloatMatrix2D B, final cern.colt.function.FloatFloatFunction function) {
		A.assign(B, function);
	}
	...
	public void dger(float alpha, FloatMatrix1D x, FloatMatrix1D y, FloatMatrix2D A) {
		cern.jet.math.FloatPlusMult fun = cern.jet.math.FloatPlusMult.plusMult(0);
		int rows = A.rows();
