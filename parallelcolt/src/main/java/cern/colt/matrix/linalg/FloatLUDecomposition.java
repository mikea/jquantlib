...
// import cern.colt.matrix.DenseFloatMatrix1D;
/**
 ...
 */
public class FloatLUDecomposition implements java.io.Serializable {
	static final long serialVersionUID = 1020;

	protected FloatLUDecompositionQuick quick;
	...
	public FloatLUDecomposition(FloatMatrix2D A) {
		quick = new FloatLUDecompositionQuick(0); // zero tolerance for
	 ...
	 * @return (float) piv
	 */
	private float[] getFloatPivot() {
		return quick.getFloatPivot();
	}
