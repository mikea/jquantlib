 ...
 */
public class DoubleLUDecomposition implements java.io.Serializable {
	static final long serialVersionUID = 1020;

	protected DoubleLUDecompositionQuick quick;
	...
	public DoubleLUDecomposition(DoubleMatrix2D A) {
		quick = new DoubleLUDecompositionQuick(0); // zero tolerance for
