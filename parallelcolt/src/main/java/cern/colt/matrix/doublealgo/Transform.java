 ...
 * {@link cern.colt.matrix.DoubleMatrix1D} and
 * {@link cern.colt.matrix.DoubleMatrix2D}. All transformations modify the
 * first argument matrix to hold the result of the transformation. Use idioms
 * like <tt>result = mult(matrix.copy(),5)</tt> to leave source matrices
 * unaffected.
 * <p>
 ...
 * objects of {@link cern.jet.math.DoubleFunctions}, using idioms like <table>
 * <td class="PRE">
 * 
 * <pre>
...
public class Transform extends cern.colt.PersistentObject {
	 ...
	 * also shorten the name "DoubleTransform" to a name that better suits you,
	 * for example "Trans".
	 * 
	 * <pre>
	...
	private static final cern.jet.math.DoubleFunctions F = cern.jet.math.DoubleFunctions.functions; // alias
