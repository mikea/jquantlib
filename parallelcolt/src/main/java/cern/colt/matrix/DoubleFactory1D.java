 ...
 * cells. Use idioms like <tt>DoubleFactory1D.dense.make(1000)</tt> to
 * construct dense matrices, <tt>DoubleFactory1D.sparse.make(1000)</tt> to
...
public class DoubleFactory1D extends cern.colt.PersistentObject {
	...
	public DoubleMatrix1D random(int size) {
		return make(size).assign(cern.jet.math.DoubleFunctions.random());
	}
