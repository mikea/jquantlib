...
/**
 * Resizable list holding <code>Object</code> elements; implemented with
...
public class ObjectArrayList extends AbstractList {
	 ...
	 * the <i>natural ordering</i> of its elements (as by the sort method)
	 ...
	 * in this range must be <i>mutually comparable</i> (that is,
	 ...
	 * @return <tt>true</tt> if the receiver is sorted ascending,
	 ...
	 * <code>from</code>, inclusive. Tests for equality or identity as
	...
	public void shuffleFromTo(int from, int to) {
		...
		cern.jet.random.DoubleUniform gen = new cern.jet.random.DoubleUniform(new cern.jet.random.engine.DRand(new java.util.Date()));
		Object tmpElement;
		Object[] theElements = elements;
		int random;
		for (int i = from; i < to; i++) {
