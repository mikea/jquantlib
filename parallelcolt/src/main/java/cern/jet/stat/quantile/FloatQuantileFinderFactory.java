 ...
 * and unknown <tt>N</tt>. Also see {@link hep.aida.bin.QuantileFloatBin1D},
...
public class FloatQuantileFinderFactory extends Object {
	 ...
	 *            output parameter, a <tt>float[1]</tt> where the sampling
	 ...
	 */
	public static cern.colt.list.FloatArrayList newEquiDepthPhis(int quantiles) {
		cern.colt.list.FloatArrayList phis = new cern.colt.list.FloatArrayList(quantiles - 1);
