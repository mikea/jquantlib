 ...
 * used for call-backs.
 * <p>
 * Unary functions are of type {@link cern.colt.function.DoubleFunction},
 * binary functions of type {@link cern.colt.function.DoubleDoubleFunction}.
 * All can be retrieved via <tt>public 
 static final</tt> variables named after
 * the function. Unary predicates are of type
 * {@link cern.colt.function.DoubleProcedure}, binary predicates of type
 * {@link cern.colt.function.DoubleDoubleProcedure}. All can be retrieved via
 * <tt>public 
...
public class DoubleFunctions extends Object {
	 ...
	 * {@link cern.jet.random.engine.DoubleMersenneTwister} and is seeded with
	 * the current time.
	 * <p>
	 * Note that any random engine derived from
	 * {@link cern.jet.random.engine.DoubleRandomEngine} and any random
	 * distribution derived from
	 * {@link cern.jet.random.AbstractDoubleDistribution} are function objects,
