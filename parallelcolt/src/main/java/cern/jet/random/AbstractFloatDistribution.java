 ...
 * <p>
 * {@link cern.jet.random.engine.FloatMersenneTwister} is recommended as uniform
 ...
 */
public abstract class AbstractFloatDistribution extends cern.colt.PersistentObject implements cern.colt.function.FloatFunction, cern.colt.function.IntFunction {
	 ...
	 * {@link cern.jet.random.engine.FloatMersenneTwister}.
	 */
	public static FloatRandomEngine makeDefaultGenerator() {
		return cern.jet.random.engine.FloatRandomEngine.makeDefault();
	}
