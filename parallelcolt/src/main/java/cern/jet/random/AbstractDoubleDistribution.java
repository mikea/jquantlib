 ...
 * <p>
 * {@link cern.jet.random.engine.DoubleMersenneTwister} is recommended as
 ...
 */
public abstract class AbstractDoubleDistribution extends cern.colt.PersistentObject implements cern.colt.function.DoubleFunction, cern.colt.function.IntFunction {
	 ...
	 * {@link cern.jet.random.engine.DoubleMersenneTwister}.
	 */
	public static DoubleRandomEngine makeDefaultGenerator() {
		return cern.jet.random.engine.DoubleRandomEngine.makeDefault();
	}
