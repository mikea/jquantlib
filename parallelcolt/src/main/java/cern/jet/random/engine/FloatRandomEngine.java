 ...
 * intervals, then randomly choosing one subinterval. <tt>float</tt>'s are
...
public abstract class FloatRandomEngine extends cern.colt.PersistentObject implements cern.colt.function.FloatFunction, cern.colt.function.IntFunction {
	/**
	...
	public static FloatRandomEngine makeDefault() {
		return new cern.jet.random.engine.FloatMersenneTwister((int) System.currentTimeMillis());
	}
