...
public class FloatRandomSampler extends cern.colt.PersistentObject {
	...
	public FloatRandomSampler(long n, long N, long low, FloatRandomEngine randomGenerator) {
		...
		if (randomGenerator == null)
			randomGenerator = cern.jet.random.AbstractFloatDistribution.makeDefaultGenerator();
	...
	public static void test(long n, long N, long low, int chunkSize, int times) {
		...
		for (long t = times; --t >= 0;) {
			FloatRandomSampler sampler = new FloatRandomSampler(n, N, low, cern.jet.random.AbstractFloatDistribution.makeDefaultGenerator());
