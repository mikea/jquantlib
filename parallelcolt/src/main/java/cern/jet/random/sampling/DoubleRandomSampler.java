...
public class DoubleRandomSampler extends cern.colt.PersistentObject {
	...
	public DoubleRandomSampler(long n, long N, long low, DoubleRandomEngine randomGenerator) {
		...
		if (randomGenerator == null)
			randomGenerator = cern.jet.random.AbstractDoubleDistribution.makeDefaultGenerator();
	...
	public static void test(long n, long N, long low, int chunkSize, int times) {
		...
		for (long t = times; --t >= 0;) {
			DoubleRandomSampler sampler = new DoubleRandomSampler(n, N, low, cern.jet.random.AbstractDoubleDistribution.makeDefaultGenerator());
