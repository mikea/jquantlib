...
public class DoubleConverter {
	...
	public String toString(DoubleIHistogram1D h) {
		...
		hep.aida.bin.DoubleBinFunction1D[] aggr = null; // {hep.aida.bin.BinFunctions1D.sum};
		String format = "%G";
		// String format = "%1.2G";
	...
	public String toString(DoubleIHistogram2D h) {
		...
		hep.aida.bin.DoubleBinFunction1D[] aggr = { hep.aida.bin.DoubleBinFunctions1D.sum };
		String format = "%G";
		// String format = "%1.2G";
