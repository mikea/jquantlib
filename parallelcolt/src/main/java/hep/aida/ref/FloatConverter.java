...
import hep.aida.FloatIHistogram2D;
import hep.aida.FloatIHistogram3D;
...
public class FloatConverter {
	...
	String form(cern.colt.matrix.impl.Former formatter, float value) {
	...
	public String toString(FloatIHistogram1D h) {
		...
		hep.aida.bin.FloatBinFunction1D[] aggr = null; // {hep.aida.bin.BinFunctions1D.sum};
		String format = "%G";
		// String format = "%1.2G";
		...
		cern.colt.matrix.FloatMatrix2D heights = new cern.colt.matrix.impl.DenseFloatMatrix2D(1, h.xAxis().bins());
		...
		return title + sep + "Heights:" + sep + new cern.colt.matrix.floatalgo.Formatter().toTitleString(heights, yEdges, xEdges, rowAxisName, columnAxisName, null, aggr);
		/*
		 * + sep + "Errors:" + sep + new
	...
	public String toString(FloatIHistogram2D h) {
		...
		hep.aida.bin.FloatBinFunction1D[] aggr = { hep.aida.bin.FloatBinFunctions1D.sum };
		String format = "%G";
		// String format = "%1.2G";
		...
		new cern.colt.list.ObjectArrayList(yEdges).reverse(); // keep coord.
		// system

		cern.colt.matrix.FloatMatrix2D heights = new cern.colt.matrix.impl.DenseFloatMatrix2D(toArrayHeights(h));
	...
	public String toString(FloatIHistogram3D h) {
		...
		new cern.colt.list.ObjectArrayList(zEdges).reverse(); // keep coord.
		// system

		cern.colt.matrix.FloatMatrix3D heights = new cern.colt.matrix.impl.DenseFloatMatrix3D(toArrayHeights(h));
		...
		return title + sep + "Heights:" + sep + new cern.colt.matrix.floatalgo.Formatter().toTitleString(heights, zEdges, yEdges, xEdges, sliceAxisName, rowAxisName, columnAxisName, "", aggr);
		/*
		 * + sep + "Errors:" + sep + new
		 * cern.colt.matrix.floatalgo.Formatter().toTitleString(
		 * errors,yEdges,xEdges,rowAxisName,columnAxisName,null,aggr);
