 ...
 */
public abstract class AbstractFloatBin1D extends AbstractFloatBin implements cern.colt.buffer.FloatBufferConsumer {
	/**
	 ...
	 */
	public synchronized cern.colt.buffer.FloatBuffer buffered(int capacity) {
		return new cern.colt.buffer.FloatBuffer(this, capacity);
	}
