...
import cern.jet.stat.quantile.DoubleQuantileFinderFactory;
 ...
 * element (<tt>double</tt>) takes 8 byte. The number of elements required
 * is then <tt>MB*1024*1024/8</tt>.
 * <p>
 * <b>Parameters:</b>
 * <ul>
...
public class QuantileDoubleBin1D extends MightyStaticDoubleBin1D {
	 ...
	 *            the desired number of subintervals per interval.
	 */
	public synchronized MightyStaticDoubleBin1D[] splitApproximately(hep.aida.DoubleIAxis axis, int k) {
		DoubleArrayList percentages = new DoubleArrayList(new hep.aida.ref.DoubleConverter().edges(axis));
