...
public class FloatFFT_1D {
	...
	protected FloatFFT_1D(int n, int[] ip, float[] w) {
	 ...
	 * <code>a</code>. Complex data is represented by 2 float values in
	...
	protected void complexForward(float[] a, int starta) {
		int nw;
		int twon = 2 * n;
		nw = ip[0];
		if (twon > (nw << 2)) {
	...
	protected void complexInverse(float[] a, int starta, boolean scale) {
		int nw;
		int twon = 2 * n;
		nw = ip[0];
		if (twon > (nw << 2)) {
	...
	protected void realForward(float[] a, int starta) {
		int nw, nc;
		float xi;
	...
	protected void realForwardFull(float[] a, int starta) {
		int nw, nc;
		float xi;
		int twon = 2 * n;
		nw = ip[0];
	...
	protected void realInverse(float[] a, int starta, boolean scale) {
		int nw, nc;
		float xi;
	...
	protected void realInverseFull(float[] a, int starta, boolean scale) {
		int nw, nc;
		float xi;
		int twon = 2 * n;
		nw = ip[0];
	...
	private void cftxb020(float[] a, int starta) {
		float x0r, x0i;
	...
	private void scale(final int m, final float[] a, int starta, boolean complex) {
		int locn;
		if (complex) {
			locn = 2 * n;
		} else {
