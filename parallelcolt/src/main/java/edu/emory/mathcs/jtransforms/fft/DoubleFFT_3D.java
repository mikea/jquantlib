...
public class DoubleFFT_3D {
	 ...
	 * rowStride = n3. Complex data is represented by 2 double values in
	...
	public void realForwardFull(double[][][] a) {
		...
		if ((np > 1) && ((double) n1 * n2 * n3 >= (double) FFT3D_THREADS_BEGIN_N)) {
			fillSymmetric(a);
		} else {
	...
	private void xdft3da_sub(int icr, int isgn, double[] a, boolean scale) {
	...
	private void xdft3da_subth(final int icr, final int isgn, final double[] a, final boolean scale) {
		final int nthread;
		int nt, i;
