...
/**
 * Computes 2D Discrete Cosine Transform (DCT) of double precision data where
...
public class DoubleDCT_2D {
	...
	private DoubleDCT_1D dctn2, dctn1;
	 ...
	 */
	public DoubleDCT_2D(int n1, int n2) {
		...
		dctn2 = new DoubleDCT_1D(n2, ip, w);
		dctn1 = new DoubleDCT_1D(n1, ip, w);
		this.np = Utils.getNP();
		;
		nt = 4 * np * n1;
		if (n2 == 2 * np) {
