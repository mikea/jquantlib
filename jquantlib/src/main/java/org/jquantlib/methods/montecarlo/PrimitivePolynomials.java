   ...
   */
	...
	*/
	...
	if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_01) {
		static final long[] PrimitivePolynomialDegree02 = { 1, -1};
	}
	
	else if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_02) {
		static final long PrimitivePolynomialDegree03[]={
			1, // x^3    +x+1 (1)01(1) 
			2, // x^3+x^2  +1 (1)10(1)
			-1 };
	}
		...
		static final long PrimitivePolynomialDegree04[]={
			1, // x^4+       +x+1 (1)001(1) 
			4, // x^4+x^3+     +1 (1)100(1) 
			-1 };
	}
	...
	if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_04) {
		static final long PrimitivePolynomialDegree05[]={
	...
	if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_05) {
		static final long PrimitivePolynomialDegree06[]={
			1,  // x^6                +x+1 (1)00001(1) 
	...
	if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_06) {
		static final long PrimitivePolynomialDegree07[]={
	...
	static final long PrimitivePolynomialDegree08[]={
	14,
	21,
	22,
	38,
	...
	static final long PrimitivePolynomialDegree09[]={
	8,
	13,
	16,
	22,
	...
	static final long PrimitivePolynomialDegree10[]={
	4,
	13,
	19,
	22,
	...
	static final long PrimitivePolynomialDegree11[]={
	2,
	11,
	21,
	22,
	...
	static final long PrimitivePolynomialDegree12[]={
	41,
	52,
	61,
	62,
	...
	static final long PrimitivePolynomialDegree13[]={
	13,
	19,
	26,
	41,
	...
	static final long PrimitivePolynomialDegree14[]={
	21,
	28,
	41,
	47,
	...
	static final long PrimitivePolynomialDegree15[]={
	1,
	8,
	11,
	22,
	...
	static final long PrimitivePolynomialDegree16[]={
	22,
	28,
	31,
	41,
	...
	static final long PrimitivePolynomialDegree17[]={
	4,
	7,
	16,
	22,
	...
	static final long PrimitivePolynomialDegree18[]={
	19,
	31,
	38,
	61,
	...
	// TODO: Add this code to Configuration.java or Settings.java.
	...
	final long PrimitivePolynomials[N_MAXDEGREE];
	
	if (PPMT_MAX_DIM > N_PRIMITIVE_UP_TO_DEGREE_01) {
		N_MAXDEGREE = PrimitivePolynomialDegree02;
	}
	else if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_02) {
		N_MAXDEGREE = PrimitivePolynomialDegree03;
	}
	else if (PPMT_MAX_DIM > N_PRIMITIVES_UP_TO_DEGREE_03) {
		N_MAXDEGREE = PrimitivePolynomialDegree04;
	}
	else { 
		N_MAXDEGREE = PrimitivePolynomialDegree01;
	}
