...
//		private CurveTraits			curve;
//		private YieldTraits			traits;
//		private CurveData			curveData;
//
//		public PiecewiseYieldLazyCurve(final YieldTermStructure yts, final CurveTraits curve, final YieldTraits traits, final CurveData curveData) {
//			this.yts = yts;
//			this.curve = curve;
//			this.traits = traits;
...
//				if (Double.isNaN(curveData.instruments[i].quoteValue()))
...
//			for (int i = 0; i < n; i++) {
//				dates[i + 1] = curveData.instruments[i].latestDate();
...
//				if (!interpolator.global()) break; // no need for convergence loop
//
...
//				Date m1 = curveData.instruments[i - 1].latestDate();
//				Date m2 = curveData.instruments[i].latestDate();
