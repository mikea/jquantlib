...
public abstract class RateHelper<T extends TermStructure> implements Observer, Observable {
    ...
    public final /* @Real */ double quoteError() {
        return quote.currentLink().value() - impliedQuote();
    }

    public final /* @Real */ double quoteValue() {
        return quote.currentLink().value();
    }

    public /* @Real */ double referenceQuote() /* @ReadOnly */ {
        return quote.currentLink().value();
    }
    ...
    //XXX:registerWith
    //    @Override
    //    public void registerWith(final ObservableValue o) {
    //        o.addObserver(this);
    //    }
    //
    //    @Override
    //    public void unregisterWith(final ObservableValue o) {
