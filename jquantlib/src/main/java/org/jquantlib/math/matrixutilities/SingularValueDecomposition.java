...
import org.jquantlib.math.MathUtil;
 ...
 * ------------------------ */
   ...
   */
   ...
   public SingularValueDecomposition (Matrix Arg) {
      ...
      // Initialize.
      double[][] A = new Matrix(Arg).getRawData();
      m = Arg.rows();//getRowDimension();
      n = Arg.columns();//getColumnDimension();
      int nu = Math.min(m,n);
