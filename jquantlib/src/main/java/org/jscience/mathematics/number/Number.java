...
public abstract class Number<T extends Number<T>> extends java.lang.Number
    ...
    /**
     * Indicates if this number is ordered equivalent to that number
     * (convenience method).
     *
     * @param that the number to compare with.
     * @return <code>this.compareTo(that) < 0</code>.
     */
    public final boolean isEQ(T that) {
        return this.compareTo(that) == 0;
    }

    /**
     * Indicates if this number is ordered not equivalent to that number
     * (convenience method).
     *
     * @param that the number to compare with.
     * @return <code>this.compareTo(that) < 0</code>.
     */
    public final boolean isNE(T that) {
        return this.compareTo(that) != 0;
    }
     ...
     * @return <code>this.compareTo(that) < 0</code>.
     */
    public final boolean isLT(T that) {
        return this.compareTo(that) < 0;
    }

    /**
     * Indicates if this number is ordered before or equivalent to that number
     * (convenience method).
     *
     * @param that the number to compare with.
     * @return <code>this.compareTo(that) < 0</code>.
     */
    public final boolean isLE(T that) {
        return this.compareTo(that) <= 0;
    }
     ...
     * @return <code>this.compareTo(that) > 0</code>.
     */
    public final boolean isGT(T that) {
        return this.compareTo(that) > 0;
    }

    /**
     * Indicates if this number is ordered after or equivalent to that number
     * (convenience method).
     *
     * @param that the number to compare with.
     * @return <code>this.compareTo(that) > 0</code>.
     */
    public final boolean isGE(T that) {
        return this.compareTo(that) >= 0;
    }
