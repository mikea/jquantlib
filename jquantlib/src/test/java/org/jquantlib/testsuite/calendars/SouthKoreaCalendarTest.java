 ...
 *
 */
public class SouthKoreaCalendarTest extends BaseCalendarTest{
    ...
    public void testSouthKoreaKRXHolidaysYear2004() {
        ...
        expectedHol.add(getDate(1, MARCH, year));
        expectedHol.add(getDate(5, APRIL, year));
        expectedHol.add(getDate(15, APRIL, year));
        expectedHol.add(getDate(5, MAY, year));
        expectedHol.add(getDate(26, MAY, year));
        expectedHol.add(getDate(27, SEPTEMBER, year));
    ...
    public void testSouthKoreaKRXHolidaysYear2005() {
        ...
        expectedHol.add(getDate(5, APRIL, year));
        expectedHol.add(getDate(5, MAY, year));
        expectedHol.add(getDate(6, JUNE, year));
        expectedHol.add(getDate(15, AUGUST, year));
        expectedHol.add(getDate(19, SEPTEMBER, year));
    ...
    public void testSouthKoreaKRXHolidaysYear2006() {
        ...
        expectedHol.add(getDate(5, MAY, year));
        expectedHol.add(getDate(6, JUNE, year));
        expectedHol.add(getDate(17, JULY, year));
        expectedHol.add(getDate(15, AUGUST, year));
        expectedHol.add(getDate(3, OCTOBER, year));
    ...
    public void testSouthKoreaKRXHolidaysYear2007() {
        ...
        expectedHol.add(getDate(26, SEPTEMBER, year));
        expectedHol.add(getDate(3, OCTOBER, year));
        expectedHol.add(getDate(25, DECEMBER, year));
    ...
    public void testSouthKoreaKRXHolidaysYear2008() {
        ...
        expectedHol.add(getDate(17, JULY, year));
        expectedHol.add(getDate(15, AUGUST, year));
        expectedHol.add(getDate(15, SEPTEMBER, year));
        expectedHol.add(getDate(3, OCTOBER, year));
        expectedHol.add(getDate(25, DECEMBER, year));
