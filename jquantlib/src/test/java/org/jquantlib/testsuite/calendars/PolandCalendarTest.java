...
public class PolandCalendarTest extends BaseCalendarTest{
    ...
    public void testPolandSettlementHolidaysYear2005()
    {
    	...
    	// expectedHol.add(getDate( 1,MAY,year));
    	expectedHol.add(getDate( 3,MAY,year));
    	// expectedHol.add(getDate(15,MAY,year));
    ...
    public void testPolandSettlementHolidaysYear2006()
    {
    	...
    	// expectedHol.add(getDate( 1,JANUARY,year));
    	// expectedHol.add(getDate(16,APRIL,year));
    ...
    public void testPolandSettlementHolidaysYear2007()
    {
    	...
    	expectedHol.add(getDate( 1,MAY,year));
    	expectedHol.add(getDate( 3,MAY,year));
    	// expectedHol.add(getDate(27,MAY,year));
    ...
    public void testPolandSettlementHolidaysYear2008()
    {
    	...
    	expectedHol.add(getDate(1,MAY,year));
    	// expectedHol.add(getDate(11,MAY,year));
    ...
    public void testPolandSettlementHolidaysYear2011()
    {
    	...
    	// expectedHol.add(getDate( 1,JANUARY,year));
    	// expectedHol.add(getDate(24,APRIL,year));
