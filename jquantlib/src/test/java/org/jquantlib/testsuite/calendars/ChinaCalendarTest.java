...
public class ChinaCalendarTest extends BaseCalendarTest{
    ...
    public void testChinaSSEYear2004() {
        ...
        expectedHol.add(getDate(27, JANUARY, year));
        ...
        expectedHol.add(getDate(6, MAY, year));
        ...
        expectedHol.add(getDate(7, OCTOBER, year));
    ...
    public void testChinaSSEYear2009() {
        ...
        expectedHol.add(getDate(27, JANUARY, year));
        expectedHol.add(getDate(28, JANUARY, year));
        expectedHol.add(getDate(29, JANUARY, year));
        expectedHol.add(getDate(30, JANUARY, year));
