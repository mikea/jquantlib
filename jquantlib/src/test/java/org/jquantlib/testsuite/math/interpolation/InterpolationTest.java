...
//	@Test
//	public void check1stDerivativeValue(const char* type,
//	                             const CubicSpline& spline,
//	                             Real x,
//	                             Real value) {
...
//
//	@Test
//	public void check2ndDerivativeValue(const char* type,
//	                             const CubicSpline& spline,
//	                             Real x,
//	                             Real value) {
...
//
//	@Test
//	public void checkNotAKnotCondition(const char* type,
//	                            const CubicSpline& spline) {
//	    Real tolerance = 1.0e-14;
...
//
//	@Test
//	public void checkSymmetry(const char* type,
//	                   const CubicSpline& spline,
//	                   Real xMin) {
...
//	        double calculatedVol = new SabrVolatility(
//	        								strikes[i], forward, expiry,
//	                                        initialAlpha, initialBeta,
//	                                        initialNu, initialRho);
//	        StringBuilder sb = new StringBuilder();
//	        sb.append("failed to calculate Sabr function at strike ").append(strikes[i]);
//	        sb.append("\n    expected:   ").append(volatilities[i]);
